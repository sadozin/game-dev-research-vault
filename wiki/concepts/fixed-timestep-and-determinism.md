...
A 2× speed control should execute two ordinary fixed steps per real-time interval, not double the
step duration. Enlarging `dt` changes discrete collision, range, projectile, and status outcomes.
