...
- **blender-mcp-scene-cleanup** (2026-07-11) — `wiki/concepts/blender-mcp-scene-cleanup.md`,
  ...
  Collection-aware cleanup, ownership hazards, diagnostics, diffs, and reversible edits.
...
- **blender-mcp-bake-and-uv** (2026-07-11) — `wiki/concepts/blender-mcp-bake-and-uv.md`,
  ...
  UV/bake prerequisites, source-target validation, long-running operations, and output safety.
...
- **blender-mcp-modeling-workflow** (2026-07-11) — `wiki/concepts/blender-mcp-modeling-workflow.md`,
  ...
  Context-safe mesh operations, stable targets, checkpoints, and topology validation.

- **unity-mcp-import-settings** (2026-07-11) — `wiki/concepts/unity-mcp-import-settings.md`,
  `wiki/sources/unity-presets-and-import-settings.md`, `wiki/sources/mcp-tools-import-safety.md`.
  Preset-driven importer changes, path scope, platform overrides, reimport, and rollback.

- **unity-mcp-build-automation** (2026-07-11) — `wiki/concepts/unity-mcp-build-automation.md`,
  `wiki/sources/unity-command-line-builds.md`, `wiki/sources/mcp-tools-build-approval.md`.
  Allowlisted build entry points, targets, logs, output safety, and release boundaries.
...
- **unity-mcp-material-setup** (2026-07-11) — `wiki/concepts/unity-mcp-material-setup.md`,
  ...
  Shared assets, per-renderer overrides, shader property validation, and SRP tradeoffs.
